...
from deep_learning.datasets import build_clip_moco_dataset, build_moco_dataset
from deep_learning.moco_v2 import FrozenClipMocoV2, MocoV2, save_moco_checkpoint
...
def train_one_epoch(model, loader, criterion, optimizer, device, epoch, max_batches):
    model.train()
    total_loss = 0.0
    total_count = 0
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        metrics.append(train_one_epoch(model, loader, criterion, optimizer, device, epoch, args.max_batches))
